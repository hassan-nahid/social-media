...
const Home = () => {
  ...
  return (
    <div className='relative flex max-w-[1440px] mx-auto gap-4 h-full'>
      ...
      <div className='w-[27%] scroll-on-hover hidden lg:block overflow-y-auto h-[calc(100vh-65px)]'>
        <ProfileSection />
      </div>

      {/* Feed section */}
      <div className='w-full scroll-on-hover  lg:w-[46%] overflow-y-auto h-[calc(100vh-65px)]'>
        <FeedSection />
      </div>
      ...
      {/* Sidebar - mobile only */}
      <div
        className={`fixed top-0 right-0 h-full w-[90%] max-w-sm z-50 transform transition-transform duration-300 ease-in-out ${
