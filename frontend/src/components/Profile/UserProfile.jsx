...
const UserProfile = () => {
    ...
    return (
        <div className='flex flex-col items-center text-center bg-[#282828] rounded-xl p-6  shadow-lg m-4 md:m-0 '>
            ...
            <h1 className='text-2xl md:text-3xl font-bold text-[#FFFFFF] mt-4'>Abdur Rahman</h1>
            <p className='text-gray-300 mt-2 max-w-md px-4'>UI/UX Designer & Frontend Developer | Creating beautiful digital experiences</p>
