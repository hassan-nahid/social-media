...
const ChatHeader = ({ toast, onToast, onBack }) => {
  const user = {
        ...
        <div className="dropdown cursor-pointer dropdown-end">
          ...
          <ul tabIndex={0} className="dropdown-content menu bg-[#212121] rounded-box z-1 w-52 shadow-sm flex flex-col gap-4 p-4">
            <button
              ...
              style={{ background: "linear-gradient(10deg, #282828 -28.66%, #8E8E8E 386.98%)" }}
            >
              View Profile
            </button>
            <button
        ...
        <div className="modal-box bg-[#212121] text-white">
          ...
          <form method="dialog" className="space-y-3">
            ...
            <div className="modal-action mt-6 flex justify-end">
              ...
              <button type="submit" className="btn bg-[#ED4337] text-white">Report</button>
            </div>
          </form>
        </div>
      </dialog>
